...
/**
 * 枣强中医院（zaoqiang-tcm-001）众阳 OpenAPI 环境凭证。
 * <p>接口名称：SPD对接。联调默认使用 {@link #TEST}（与 zhongyang {@code GrayTest} 一致），
 * 上线前将 {@code scminterface.customer.zaoqiang-tcm-001.msun.active-env} 改为 {@code prod}。</p>
 */
