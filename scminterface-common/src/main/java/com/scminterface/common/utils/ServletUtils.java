...
public class ServletUtils
{
    ...
    {
        return StringUtils.nvl(Integer.valueOf(getRequest().getParameter(name)), defaultValue);
    }
    ...
    public static String getDomain(ServletRequest request)
    {
        ...
        return url.delete(url.length() - request.getContentLength(), url.length()).append(contextPath).toString();
    }
}
